...
exports.run = async (client, message, args) => {
  ...
  if (
    ...
    return message.channel.send(
      "<:zen_wrong:952131605080727552> You need to have the manage messages permissions to reroll giveaways."
    );
  }
  ...
  if (!args[0]) {
    return message.channel.send(
      "<:zen_wrong:952131605080727552> You have to specify a valid message ID!"
    );
  }
